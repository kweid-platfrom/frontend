...
const BugTrackingMetrics = ({ filters = {} }) => {
        ...
        const { metrics, loading, error, hasAccess } = useBugTrackingMetrics(filters);

                // Use metrics from the hook, with defaults for missing fields
                    ...
                    <div className="bg-red-50 border border-red-200 rounded-lg p-6">
                        <div className="flex items-center">
                            ...
                            <p className="text-red-800 font-medium">
                                {isAuthenticated
                                    ? 'You do not have permission to view bug metrics for this suite.'
