                ...
                {recording?.videoUrl ? (
                  ...
                  <div className="h-full flex items-center justify-center text-gray-400 dark:text-gray-600">
                    <div className="text-center p-6">
                      ...
                      <div className="text-base md:text-lg font-medium">No video available</div>
                      <div className="text-xs md:text-sm text-gray-500 dark:text-gray-500 mt-2">
                        This recording doesn&apost have a video file
                      </div>
                    </div>
                  </div>
                )}
            ...
            <div className="flex-shrink-0 p-3 md:p-4 lg:p-6 pt-0 lg:pt-0">
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
                <RecorderTimeline
                  ...
                  videoRef={videoRef}
                  enableTrimming={false} // Disables trimming
                />
              </div>
            </div>
          </div>
