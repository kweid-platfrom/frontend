import React from 'react';import { Square } from 'lucide-react';
const ReviewStep = ({    formData,    errors,    accountType,    onInputChange,    onPrev,    onCreateAccount,    isCreatingAccount,}) => {    const companyTypes = [        { value: 'startup', label: 'Startup' },        { value: 'small_business', label: 'Small Business' },        { value: 'corporation', label: 'Corporation' },        { value: 'non_profit', label: 'Non-Profit' },        { value: 'government', label: 'Government' },        { value: 'education', label: 'Education' },        { value: 'healthcare', label: 'Healthcare' },        { value: 'other', label: 'Other' }    ];
return (
                ...
                <div className="space-y-4">
                    <div>
                        ...
                        <input
                            ...
                            className="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-teal-500 border-slate-200"
