    ...
    const SuccessScreen = () => (
        <div className="text-center">
            ...
            {successMessage.includes('verify') && (
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 sm:p-4 mb-6 text-left mx-2 sm:mx-0">
            ...
            <button
                ...
                className="w-full bg-gradient-to-r from-teal-600 to-cyan-600 text-white py-3 px-4 rounded-lg hover:from-teal-700 hover:to-cyan-700 transition-all transform hover:scale-[1.02] font-medium shadow-lg text-sm sm:text-base"
            >
                Continue to Sign In
            </button>
        </div>
