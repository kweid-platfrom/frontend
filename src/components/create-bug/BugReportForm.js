...
const BugReportForm = ({
    ...
    return (
        <div className="flex flex-col h-full bg-background">
            {/* Header Section */}
            <div className="flex-shrink-0 bg-card border-b border-border px-6 sm:px-8 py-4 shadow-theme-sm">
                <div className="flex items-center">
                    <DocumentTextIcon className="h-6 w-6 mr-3 text-primary" />
                    <h2 className="text-xl font-semibold text-foreground">Bug Report Form</h2>
                </div>
            </div>
