                ...
                <div className={`p-4 border-b border-gray-200/50 transition-all duration-300 ${isCollapsed ? 'lg:px-2' : 'px-4'
                    ...
                    <div className="relative group">
                        ...
                        >
                            ...
                            <svg className={`h-4 w-4 text-gray-400 flex-shrink-0 transition-all duration-300 ${isCollapsed ? 'lg:opacity-0 lg:w-0' : 'opacity-100 w-4'
                                ...
                                {isPremiumUser() ? (
                                        ...
                                        <div className="space-y-1">
                                            {projects.map((project) => (
                                                <button
                                                    ...
                                                    className={`w-full flex items-center p-2.5 text-left rounded-lg hover:bg-gray-50 transition-all duration-200 hover:scale-[1.01] ${activeProject?.id === project.id ? 'bg-blue-50 text-teal-700 ring-1 ring-blue-200' : 'text-gray-900'
                                                        }`}
                                                >
                                    ...
                                    <>
                                        ...
                                        <div className="text-center py-4">
                                            <div className="mx-auto w-12 h-12 bg-gradient-to-r from-accent-600 to-teal-600 rounded-full flex items-center justify-center mb-3">
                                            ...
                                            <button
                                                ...
                                                className="w-full bg-gradient-to-r from-accent-600 to-teal-700 text-white px-4 py-2.5 rounded text-sm font-medium hover:from-accent-600 hover:to-teal-700 transition-all duration-200 hover:scale-[1.02] shadow-sm"
                                            >
                                                Upgrade Now
                                            </button>
                    ...
                    {navigation.map((item) => {
                        ...
                        return (
                            <div key={item.name} className="relative group">
                                ...
                                >
                                    <item.icon
                                        className={`h-5 w-5 flex-shrink-0 transition-all duration-200 ${isActive ? 'text-teal-700' : 'text-teal-700 group-hover/btn:text-gray-600'
                                            }`}
                                    />
